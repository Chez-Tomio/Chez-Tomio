...
export const ProductsForm: React.FC<ProductsFormProps> = ({ initialValues, onUpdateProduct }) => {
    return (
        <Formik
        ...
        >
            {({ values, isSubmitting }) => (
                <Form
                    ...
                    `}
                >
                    <h3>{values.title ? `Editing ${values.title.fr}` : 'Adding New Product'}</h3>
                    <div className="item">
                    ...
                    <div className="item">
                        ...
                        <Field name="minimumPrice" type="number" />
                    </div>
