...
function App({ Component: Page, pageProps }: AppProps) {
    ...
    // const [globalState, setGlobalState] = useState<Partial<GlobalStateInterface>>(
    ...
    // Once everytime a page is loaded
    // useEffect(() => {
    //     // Add local storage cart items to global state
    ...
    //     console.log('Loaded local storage cart products', globalState);
    // }, []);

    // // When the global state changes
    // useEffect(() => {
    //     console.log(globalState);
    //     setCartProductsCount(0);
    //     if (globalState.cartItems) {
    //         globalState.cartItems.map((cartItem) =>
    //             setCartProductsCount((i) => i + cartItem.count),
    //         );
    //     }
                        ...
                        <Header backgroundFull={pageProps.headerBackgroundFull}>
                            ...
                            {globalConfig.isStoreEnabled && (
                                ...
                                >
                                    <Link href="/panier">
                                        <div>
                                            <NavCartButton cartProductsCount={cartProductsCount} />
                                        </div>
                                    </Link>
                                </div>
                            )}
